export class Perso {
    constructor(nom, race, force, magie, vie, enVie, xp) {
        this.nom = nom;
        this.race = race;
        this.force = force;
        this.magie = magie;
